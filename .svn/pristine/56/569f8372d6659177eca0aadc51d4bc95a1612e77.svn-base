...
/*****************************************************************************
*
*   @ SYSTEM NAME       : 간편결제 공통함수
*   @ PROGRAM NAME      : common_epay.jsp
*   @ MAKER             : InnoPay PG
*   @ MAKE DATE         : 2020.04.08
*   @ PROGRAM CONTENTS  : 간편결제
*
******************************************************************************/
%>
...
request.setCharacterEncoding("utf-8");
    String actionUrl = "payConfirm_EPay.jsp";
    String pointStr = "";
    String pointUseYN = "";
    String TID = "";
...
**/
    ...
    Key = client.queryForMap("epay_pg_mid.select",req2,"svc_cd","pg_mid");
    String Kakao_Key = Key.get("16");  //카카오
    String Lpay_Key = Key.get("17");   //LPAY
    String Payco_Key = Key.get("18");  //PAYCO
    String Ssg_Key = Key.get("19");    //SSG
    String Naver_Key = Key.get("20");    //SSG
    System.out.println("**********[Sndstoreid]**********");
    System.out.println("Kakao_Key : "+Kakao_Key);
    System.out.println("Lpay_Key : "+Lpay_Key);
    System.out.println("Payco_Key : "+Payco_Key);
    System.out.println("Ssg_Key : "+Ssg_Key);
    System.out.println("Naver_Key : "+Naver_Key);
    // 2. 주문번호 특수문자 체크
    ...
    boss_nm    = resMemberInfo.getString("boss_nm");
    tel_no    = resMemberInfo.getString("tel_no");
    addr_no1 = resMemberInfo.getString("addr_no1");
    addr_no2 = resMemberInfo.getString("addr_no2");
    post_no = resMemberInfo.getString("post_no");
    addr = post_no+ " " + addr_no1 + " " + addr_no2; 	
