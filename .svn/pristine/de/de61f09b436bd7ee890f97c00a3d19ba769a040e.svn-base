...
-->
<%
System.out.println("---- start m_SMPIAgent01.jsp ----");
	...
	if (request.getServerPort() == 80 || request.getServerPort() == 443) {
		RECV_URL = request.getScheme() + "://" + request.getServerName() + ":"+request.getServerPort() +"/ipay/card/rocomo/m_SMPIAgent02.jsp";
	} else {
		RECV_URL = request.getScheme() + "://" + request.getServerName() + ":"+request.getServerPort() +"/ipay/card/rocomo/m_SMPIAgent02.jsp";
	}	
...
function openSimplepay() {
	document.SIMPLEPAYFORM.method="post";
	document.SIMPLEPAYFORM.action="<%=cardPareqURL%>"; 
