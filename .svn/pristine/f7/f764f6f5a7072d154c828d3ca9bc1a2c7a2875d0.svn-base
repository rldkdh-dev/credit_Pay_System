                ...
                <table>
                    ...
                    <tbody>
                            ...
                            <td>
                                <div id="pay_method">
                                    <select style="width: 100%;" name="PayMethod" id="PayMethod">
                                        ...
                                        <option value="CSMS">SMS카드결제 Web LINK</option>
                                    </select>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input type="text" id="DutyFreeAmt" name="DutyFreeAmt" value="0" placeholder="" onKeyUp="javascript:numOnly(this,document.frm,false);" />
                                </div>
                            </td>
                        </tr>                        
