...
*	@ PROGRAM NAME		: mainBank.jsp
*   @ MAKER             : 
*	@ MAKE DATE			: 2018.01.11
...
<%
System.out.println("**** Start /bank/mainBank.jsp["+System.currentTimeMillis()+"] ****");
...
<%
	...
	*/  
	...
	String tx_returnURL = "payComfirm.jsp";
...
<body>
<form name="tranMgr" method="post" action="./bankpay.jsp" target="INVISIBLE">
<%-- 상점에서 입력하는 파라미터 --%>
...
<!-- 계좌이체는 CERT로 고정 -->
<input type="hidden" name="hd_ep_type"      value="SECUCERT"> <!-- SECUCERT -->
<!-- 공백으로 고정 -->
...
<!-- 금융 결제원 입금 모계좌: 2009년 07월 증권계좌 추가 적용 -->
...
<input type="hidden" name="tx_returnURL"   value="<%=tx_returnURL%>">
<div class="innopay">
            <div class="dim"></div>
