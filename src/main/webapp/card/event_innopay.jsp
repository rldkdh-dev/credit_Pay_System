...
<html lang="ko">
	...
	<body scroll=auto style="overflow-x:hidden">
		<section class="wrap">
			<iframe src="event.jsp?yyyymm=<%=yyyymm%>&pg_cd=<%=pg_cd%>&mid=<%=mid%>&svc_prdt_cd=<%=svc_prdt_cd%>" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:100%;width:100%;position:absolute;top:0px;left:0px;right:0px;bottom:0px" height="100%" width="100%"></iframe>
		</section>
