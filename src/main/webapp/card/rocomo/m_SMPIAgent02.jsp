...
// 	request.setCharacterEncoding("UTF-8");
	...
	//String reqtype = cookieUtil.getValue("com.smpi.reqtype");
	String reqtype = "";
...
<script type="text/javascript" >
	function setCert(){
		var frmNm = document.frmID;
        var r0           = frmNm.rsCode.value ;
        var msg          = frmNm.msg.value ;
        var xid          = frmNm.encXid.value ;
        var eci          = frmNm.eci.value ;
        var cavv         = frmNm.cavv.value ;
        var cardno       = frmNm.card_no.value ;
        var joinCode     = frmNm.joinCode.value ;
        var hs_useamt_sh = frmNm.hsUseamtSh.value ;
        
        parent.postMessage("setCertResult('"+r0+"','"+msg+"','"+xid+"','"+eci+"','"+cavv+"','"+cardno+"','"+joinCode+"','"+hs_useamt_sh+"')", "*");
...
<input type="hidden" name="hsUseamtSh"  value = "">
</form>
